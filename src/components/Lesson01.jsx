...
const Lesson01 = () => {
  return (
    <div className='Lesson'>
      <div className='Logo'><h2>Обратный отсчет. Три.</h2><img src="/sputnik.webp" alt="Спутник" /></div>
  <p>Просмотрите видеоролик по работе в Скретч.</p> <br />
  <a href="https://disk.yandex.ru/i/lVkAYo-WVbq_vw"  target="_blank" rel="noopener noreferrer"><img src="/O3.jpg" alt="Занятие 1" /></a>  <br />  
